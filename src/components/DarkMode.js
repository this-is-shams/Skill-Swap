...
export default function DarkMode() {
  ...
  return (
    <div className="dark:bg-indigo-100-accent pl-5">
      <div className="bg-white dark:bg-gray-800 fixed top-0 left-0 w-full pt-2 pl-8">
        <img src={logo} style={{ display: 'inline-block' }}></img>
        <h1 className="dark:text-white" style={{ display: 'inline-block', marginLeft: '-250px', fontWeight:'bold', fontSize: '22px'}}>Skill Swap</h1>
      </div>
