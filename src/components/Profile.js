        ...
        <div>
            ...
            <div className="h-screen w-screen dark:bg-slate-800 dark:text-white pl-60 pt-20 flex col">
                ...
                <div className="h-full w-full pt-14">
                    <div>
                        ...
                        {isEditable ? (
                            <input
                                type="text"
                                className="border rounded-lg px-3 py-2 mt-1 w-64"
                    ...
                    <div>
                        <h3 className="mt-1 px-3 py- font-semibold">Institution</h3>
                        {isEditable ? (
                            <input
                                type="text"
                                className="border rounded-lg px-3 py-2 mt-1 w-64"
                    ...
                    <div>
                        <h3 className="mt-1 px-3 py- font-semibold">Semester</h3>
                        {isEditable ? (
                            <input
                                type="text"
                                className="border rounded-lg px-3 py-2 mt-1 w-64"
                    ...
                    <div>
                        <h3 className="mt-1 px-3 py- font-semibold">Contact no.</h3>
                        {isEditable ? (
                            <input
                                type="text"
                                className="border rounded-lg px-3 py-2 mt-1 w-64"
                    ...
                    <div>
                        <h3 className="mt-1 px-3 py- font-semibold">Email</h3>
                        {isEditable ? (
                            <input
                                type="text"
                                className="border rounded-lg px-3 py-2 mt-1 w-64"
                ...
                <div className="h-full w-full  pt-14">
                    ...
                    <div>
                        <h3 className="mt-1 px-3 py- font-semibold">StopStalk Profile</h3>
                        {isEditable ? (
                            <input
                                type="text"
                                className="border rounded-lg px-3 py-2 mt-1 w-64"
                    ...
                    <div>
                        <h3 className="mt-1 px-3 py- font-semibold">LinkedIn Profile</h3>
                        {isEditable ? (
                            <input
                                type="text"
                                className="border rounded-lg px-3 py-2 mt-1 w-64"
